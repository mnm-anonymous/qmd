...
class DistributedMetricDistillation(distributed_layout.DistributedLayout):
    ...
    def __init__(
        ...
        def actor_logger_fn(actor_id): return metric_distillation_utils.make_logger(
            'actor',
        ...
        if evaluator_factories is None:
            ...
            def evaluator_logger_fn(label, save_data, steps_key): return metric_distillation_utils.make_logger(
                label,
                save_data=save_data,
                time_delta=log_every,
                steps_key=steps_key,
